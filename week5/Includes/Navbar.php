     ...
     <nav id="mainNav" class="navbar navbar-toggleable-md navbar-inverse bg-primary fixed-top">
          ...
          <div class="collapse navbar-collapse" id="navbar">
               <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                         <a class="nav-link page-scroll" href="Knowledge.php">Knowledge <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                         <a class="nav-link page-scroll" href="Quiz.php">Quiz <span class="sr-only">(current)</span></a>
                    </li>
               </ul>
          </div>
     </nav>
